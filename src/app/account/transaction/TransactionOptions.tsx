...
export default function TransactionOptions({transaction}) {
            ...
            <PopoverContent className="flex justify-center pl-8 rounded-2xl items-center w-[258px]">
                <div className={"w-full"}>
                    ...
                    {transaction.order_status == "shipping" && <>
                        <button className={"bt w-10/12 h-12 mt-3"} onClick={() => confirmOrder(transaction.id)}>Confirm Received</button>
                    <ShowTrackingDrawer transaction={transaction}/>
                    </>}
