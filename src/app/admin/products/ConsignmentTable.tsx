...
import ConsignmentOptions from "@/app/admin/products/ConsignmentOptions";
...
const TransactionTable = async({search}) => {
    const url = search ? `http://localhost:4000/product?search=${search}` : "http://localhost:4000/product";
